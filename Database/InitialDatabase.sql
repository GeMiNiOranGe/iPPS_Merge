...
-- change DbName here and...
DECLARE
    @DbName     NVARCHAR(Max)
  , @DeleteStmt NVARCHAR(Max)
  , @CreateStmt NVARCHAR(Max)
;

SET @DbName     = N'Pepro';
SET @DeleteStmt = N'DROP   DATABASE IF EXISTS ' + QuoteName(@DbName);
...
ALTER TABLE [dbo].[SalaryScale]
ADD
    CONSTRAINT [PK_SalaryScale] PRIMARY KEY ([SalaryScaleId])
;
...
ADD
    CONSTRAINT [PK_SalaryLevel] PRIMARY KEY ([SalaryLevelId])
;
...
ALTER TABLE [dbo].[AssignmentDetail]
ADD
    CONSTRAINT [PK_AssignmentDetail] PRIMARY KEY ([AssignmentDetailId])
;

ALTER TABLE [dbo].[DepartmentProject]
ADD
    CONSTRAINT [PK_DepartmentProject] PRIMARY KEY ([DepartmentProjectId])
;
...
ADD
    ...
    FOREIGN KEY ([SalaryScaleId]) REFERENCES [dbo].[SalaryScale]([SalaryScaleId])
;
...
ADD
  ...
  , CONSTRAINT DF_Role_CreatedAt DEFAULT GetDate() FOR CreatedAt
  , CONSTRAINT DF_Role_UpdatedAt DEFAULT GetDate() FOR UpdatedAt
;

ALTER TABLE Department
ADD
    CONSTRAINT DF_Department_IsDeleted DEFAULT 0 FOR IsDeleted
  , CONSTRAINT DF_Department_CreatedAt DEFAULT GetDate() FOR CreatedAt
  , CONSTRAINT DF_Department_UpdatedAt DEFAULT GetDate() FOR UpdatedAt
;

ALTER TABLE Project
ADD
    CONSTRAINT DF_Project_IsDeleted DEFAULT 0 FOR IsDeleted
  , CONSTRAINT DF_Project_CreatedAt DEFAULT GetDate() FOR CreatedAt
  , CONSTRAINT DF_Project_UpdatedAt DEFAULT GetDate() FOR UpdatedAt
;

ALTER TABLE Employee
ADD
    CONSTRAINT DF_Employee_IsDeleted DEFAULT 0 FOR IsDeleted
  , CONSTRAINT DF_Employee_CreatedAt DEFAULT GetDate() FOR CreatedAt
  , CONSTRAINT DF_Employee_UpdatedAt DEFAULT GetDate() FOR UpdatedAt
;

ALTER TABLE Account
ADD
    CONSTRAINT DF_Account_IsDeleted DEFAULT 0 FOR IsDeleted
  , CONSTRAINT DF_Account_CreatedAt DEFAULT GetDate() FOR CreatedAt
  , CONSTRAINT DF_Account_UpdatedAt DEFAULT GetDate() FOR UpdatedAt
;

ALTER TABLE Assignment
ADD
    CONSTRAINT DF_Assignment_IsDeleted DEFAULT 0 FOR IsDeleted
  , CONSTRAINT DF_Assignment_CreatedAt DEFAULT GetDate() FOR CreatedAt
  , CONSTRAINT DF_Assignment_UpdatedAt DEFAULT GetDate() FOR UpdatedAt
;
