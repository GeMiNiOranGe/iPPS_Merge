...
BEGIN
    SELECT
        ((LUONG.LUONGCOBAN * BACLUONG.HESOBL) + (LUONG.LUONGCOBAN * CHUCVU.HESOPHUCAP * 0.1) - (TIENNHA.TIENNHA + (BOPHANCHAMCONG.SONGAYNGHIBHXH * LUONG.LUONGCOBAN * 0.1) + (BOPHANCHAMCONG.SONGAYNGHIKHONGLYDO * LUONG.LUONGCOBAN * 0.3))) AS TongLuong
    FROM
        LUONG
    JOIN
