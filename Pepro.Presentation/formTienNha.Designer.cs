namespace Pepro.Presentation
{
    partial class formTienNha
    {
        ...
        private RichTextBox rtbTinhTien;
        private Button btnTinhTien;
        private NumericUpDown numNuoc;
        private Label label7;
        private NumericUpDown numDien;
        private DataGridViewTextBoxColumn MANTT;
        private DataGridViewTextBoxColumn MaHGD;
        private DataGridViewTextBoxColumn Thang;
        private DataGridViewTextBoxColumn TienNhaCoDinh;
        private DataGridViewTextBoxColumn HeSoDien;
        private DataGridViewTextBoxColumn HeSoNuoc;
        private DataGridViewTextBoxColumn PhiVSANTT;
        private DataGridViewTextBoxColumn TongTienNha;
