...
namespace Pepro.DataAccess {
    public class CAccountDAL {
        ...
        public bool IsAccountExist(CAccount account) {
            ...
            // Execute query
            var sqlCommand = DataProvider.Instance.CreateCommand(strQuery);
            
            // Check data
            DataProvider.Instance.OpenConnection(sqlCommand.Connection);
            var sqlDataReader = sqlCommand.ExecuteReader();
            bool bExist = sqlDataReader.HasRows;
            DataProvider.Instance.CloseConnection(sqlCommand.Connection);
        ...
        public CAccount GetAccount(CAccount account) {
            ...
            var sqlCommand = DataProvider.Instance.CreateCommand(query);
